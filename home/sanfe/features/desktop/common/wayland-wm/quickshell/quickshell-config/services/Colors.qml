...
QtObject {
    ...
    property color primaryFg:                "#11111b"
    property color primaryContainer:         "#585b70"
    property color primaryFgContainer:       "#cdd6f4"
    property color secondary:                "#89b4fa"
    property color secondaryFg:              "#1e1e2e"
    property color secondaryContainer:       "#313244"
    property color secondaryFgContainer:     "#cdd6f4"
    property color tertiary:                 "#94e2d5"
    property color tertiaryFg:               "#1e1e2e"
    property color tertiaryContainer:        "#45475a"
    property color tertiaryFgContainer:      "#cdd6f4"
    property color error:                    "#f38ba8"
    property color errorFg:                  "#11111b"
    property color errorContainer:           "#45475a"
    property color errorFgContainer:         "#f38ba8"
    property color background:               "#1e1e2e"
    property color backgroundFg:             "#cdd6f4"
    property color surface:                  "#181825"
    property color surfaceFg:                "#cdd6f4"
    property color surfaceVariant:           "#313244"
    property color surfaceFgVariant:         "#bac2de"
    ...
    property color inverseSurfaceFg:         "#1e1e2e"
    ...
    function _applyColors(text: string) {
        ...
        try {
            ...
            if (d.on_primary)               root.primaryFg               = d.on_primary
            if (d.primary_container)        root.primaryContainer        = d.primary_container
            if (d.on_primary_container)     root.primaryFgContainer      = d.on_primary_container
            if (d.secondary)                root.secondary               = d.secondary
            if (d.on_secondary)             root.secondaryFg             = d.on_secondary
            if (d.secondary_container)      root.secondaryContainer      = d.secondary_container
            if (d.on_secondary_container)   root.secondaryFgContainer    = d.on_secondary_container
            if (d.tertiary)                 root.tertiary                = d.tertiary
            if (d.on_tertiary)              root.tertiaryFg              = d.on_tertiary
            if (d.tertiary_container)       root.tertiaryContainer       = d.tertiary_container
            if (d.on_tertiary_container)    root.tertiaryFgContainer     = d.on_tertiary_container
            if (d.error)                    root.error                   = d.error
            if (d.on_error)                 root.errorFg                 = d.on_error
            if (d.error_container)          root.errorContainer          = d.error_container
            if (d.on_error_container)       root.errorFgContainer        = d.on_error_container
            if (d.background)               root.background              = d.background
            if (d.on_background)            root.backgroundFg            = d.on_background
            if (d.surface)                  root.surface                 = d.surface
            if (d.on_surface)               root.surfaceFg               = d.on_surface
            if (d.surface_variant)          root.surfaceVariant          = d.surface_variant
            if (d.on_surface_variant)       root.surfaceFgVariant        = d.on_surface_variant
            ...
            if (d.inverse_on_surface)       root.inverseSurfaceFg        = d.inverse_on_surface
